...
- AAM - Application Acceleration Manager - optimization 
- LTM - It’s a full proxy between users and application servers, creating a layer of abstraction to secure, optimize, and load balance application traffic
